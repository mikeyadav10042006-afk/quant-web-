                ...
                <div className="flex flex-wrap gap-2">
                  {suggestedQuestions.map((q, idx) => (
                    <button
                        ...
                        className="text-xs text-slate-600 hover:text-teal-600 bg-slate-50 hover:bg-teal-50 border border-slate-100 hover:border-teal-100 px-3 py-1.5 rounded-lg transition-colors text-left"
                      >
