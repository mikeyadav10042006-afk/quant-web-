      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-16">
              ...
              <div className="flex items-start space-x-3 text-sm pt-2">
                ...
                <div>
                  ...
                  {onOpenChat && (
                    <button 
                      onClick={onOpenChat}
                      className="text-xs text-teal-400 hover:text-teal-300 font-bold flex items-center space-x-1 py-2 px-1 -ml-1 mt-1 transition-colors"
                    >
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-6 text-left">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="booking-name" className="text-xs font-bold text-slate-400 uppercase">Your Name</label>
                    <input
                      id="booking-name"
                      type="text"
                      required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="booking-email" className="text-xs font-bold text-slate-400 uppercase">Work Email</label>
                    <input
                      id="booking-email"
                      type="email"
                      required
                ...
                <div className="space-y-2">
                  <label htmlFor="booking-enterprise" className="text-xs font-bold text-slate-400 uppercase">Enterprise Domain / Company</label>
                  <input
                ...
                <div className="space-y-2">
                  <label htmlFor="booking-requirements" className="text-xs font-bold text-slate-400 uppercase">System & Integration Requirements</label>
                  <textarea
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-16 border-b border-slate-800">
          ...
          <div className="w-full max-w-md bg-slate-900 p-2 rounded-2xl border border-slate-800">
            {newsSuccess ? (
              <div aria-live="polite" className="flex items-center space-x-2 text-teal-400 text-sm py-2 px-3 font-semibold justify-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-slate-500 font-medium">
            ...
            {onOpenAdmin && (
              <button onClick={onOpenAdmin} className="ml-2 p-2 rounded-lg text-slate-700/30 hover:text-slate-400 transition-colors align-middle" title="Admin">
          ...
          <div className="flex items-center space-x-1 text-slate-400">
            <a href="https://github.com" target="_blank" rel="noreferrer" className="p-3 rounded-lg hover:text-white hover:bg-white/5 transition-colors" aria-label="GitHub">
            ...
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="p-3 rounded-lg hover:text-white hover:bg-white/5 transition-colors" aria-label="Twitter">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-3 rounded-lg hover:text-white hover:bg-white/5 transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
