          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              {stat.animate ? (
                ...
                <span className="relative text-4xl font-extrabold text-teal-600 font-sans tracking-tight group-hover:text-[#009966] transition-colors duration-300 flex items-center gap-2">
